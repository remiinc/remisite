...
ogTitle: "Jobber Follow-Ups: Automating Estimate and Invoice Chasing (and Where It Stops)"
...
faq:
  - q: "Does Jobber follow up on quotes automatically?"
    a: "Yes, on the Connect plan and up. Jobber can send up to two automatic email or text reminders on a quote that is still awaiting a response, on a schedule you set. After the second reminder it stops."
  - q: "How many times will Jobber remind a client about an invoice?"
    a: "Up to two times. Jobber's invoice follow-ups fire after the due date, and you can set each one to send anywhere from the day it goes past due out to 90 days later. After two reminders, the automation goes quiet."
  - q: "Which Jobber plan do I need for automated follow-ups?"
    a: "Quote follow-ups require the Connect plan or higher, per Jobber's Help Center. Invoice follow-ups are documented on Connect and up as well, though Jobber's pricing page lists invoice reminders on lower tiers, so confirm against your own plan."
  - q: "Can Jobber follow up on invoices I sent from QuickBooks?"
    a: "No. Jobber only chases quotes and invoices created inside Jobber. An invoice you sent from QuickBooks, or an estimate you texted from your own phone, is invisible to Jobber's automations."
  - q: "Do the automated reminders keep sending if the client replies?"
...
Pricing on Jobber as of 2026 runs Core at $49 per month, Connect at $139, Grow at $199, and Plus at $499, billed monthly with no commitment, with lower rates on annual billing ([Jobber pricing](https://www.getjobber.com/pricing/)). Quote follow-ups start at the Connect tier, so the automation and the plan cost travel together.
...
1. Click the Gear icon, then open Settings.
2. Go to Emails and Text Messages (newer accounts may see an Automations section instead).
3. Find Quote follow-ups and switch the toggle to ON.
4. Click Edit to set the wording and the schedule for the first reminder.
5. Choose when it sends, anywhere from an hour after the client views the quote to several days later.
6. If you want a second nudge, enable the second quote follow-up and set its timing.
7. Save.

Two details worth knowing. Quote follow-ups send at the same time of day the original quote went out, in the client's local time. And a client only receives them if outstanding quote follow-ups is enabled in the communication settings on their client profile, which it is by default for most, but is worth checking on your best customers ([Jobber Help Center](https://help.getjobber.com/hc/en-us/articles/24244124296471-Automations)).
...
1. Click the Gear icon, then open Settings.
2. Go to Emails and Text Messages, or the Automations section if your account shows it.
3. Find Invoice follow-ups and switch the toggle to ON.
4. Click Edit and write the reminder message.
5. Set how many days after the due date the first reminder sends. You can pick anything from the due date itself out to 90 days.
6. Enable the second invoice follow-up if you want a second reminder, and set its day.
7. Save.

Invoice reminders send shortly after 8am local time on the day they are scheduled, and they go out in the same channel as the original invoice. As with quotes, each client needs overdue invoice follow-ups enabled on their profile to receive them ([Jobber Help Center](https://help.getjobber.com/hc/en-us/articles/24244124296471-Automations)). The one-click pay link is the part that earns its keep here, because it removes the step where a client means to pay and then forgets which envelope the invoice was in.
...
None of that makes the automation not worth turning on. Two out of three contractors are paid late ([Built, 2025](https://getbuilt.com/blog/70-percent-of-contractors-say-payment-delays-threaten-industry/)), and an automatic reminder with a pay link recovers real money you would otherwise leave on the table. It just means the reminders are a floor, not the whole job. QuickBooks' own guidance on collecting from customers makes the same point: the businesses that get paid are the ones that follow up consistently and personally, not just once through a template ([QuickBooks](https://quickbooks.intuit.com/r/payments/collect-outstanding-payments/)).
