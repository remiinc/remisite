---
title: "How to Send Automatic Invoice Reminders in QuickBooks Online (2026)"
description: "How to set up QuickBooks Online automatic invoice reminders in 2026: exact settings, cadence, plan limits, and where the reminders stop working."
datePublished: "2026-07-09"
author: "Hunter Hammonds"
category: "Guides"
readingTime: "8 min read"
ogTitle: "How to Send Automatic Invoice Reminders in QuickBooks Online (2026)"
...
faq:
  - q: "Which QuickBooks Online plans have automatic invoice reminders?"
    a: "Automatic invoice reminders are available in Simple Start, Essentials, and Plus. Advanced does not use the same toggle; it builds reminders through its workflows feature instead."
  - q: "How many automatic reminders can QuickBooks Online send per invoice?"
    a: "Up to three. You can set Reminder 1, Reminder 2, and Reminder 3, each timed a chosen number of days before or after the due date, up to 90 days out."
  - q: "Can QuickBooks Online send invoice reminders by text message?"
    a: "No. Built-in reminders are email only. There is no text, iMessage, WhatsApp, or phone option. You can copy an invoice link and text it yourself, but that is manual."
  - q: "Why is my QuickBooks invoice reminder not sending?"
    a: "QuickBooks only sends reminders for invoices you already emailed through QuickBooks and that are still unpaid. An invoice you printed, texted, or entered without emailing will not trigger a reminder."
  - q: "Do QuickBooks reminders work for estimates or quotes?"
    a: "No. The reminders feature only follows up on invoices. A quote or estimate that got no reply is not covered, so silent quotes still need a manual follow-up."
---
...
Here is the full setup, based on Intuit's current help documentation ([Send invoice reminders automatically or manually in QuickBooks Online](https://quickbooks.intuit.com/learn-support/en-us/help-article/invoicing/send-invoice-reminders-automatically-manually/L84cQjpxo_US_en_US)):
...
6. Select the dropdown for Reminder 1 and turn on its toggle.
7. Choose the number of days, then choose before or after the invoice due date.
8. Optionally repeat for Reminder 2 and Reminder 3.
9. Customize the subject line and message if you want, then Save.
...
Pricing and plan features change often, so confirm your current tier on Intuit's [QuickBooks Online pricing page](https://quickbooks.intuit.com/pricing/) before assuming a feature is or is not included.
...
For context on why this matters: Intuit's own [2025 Small Business Late Payments Report](https://quickbooks.intuit.com/r/small-business-data/small-business-late-payments-report-2025/) found that small businesses with outstanding invoices were owed about $17,500 on average, and 47% reported invoices more than 30 days overdue. In construction specifically, [Built's 2025 research](https://getbuilt.com/blog/70-percent-of-contractors-say-payment-delays-threaten-industry/) found roughly 70% of contractors face regular payment delays. A single automatic email is rarely what closes that gap.
