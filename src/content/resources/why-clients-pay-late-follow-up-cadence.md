---
title: "Why Clients Pay Late, and the Follow-Up Cadence That Fixes It"
description: "Why do clients pay late? The five real reasons ranked, plus the exact follow-up cadence that gets invoices paid without you nagging."
datePublished: "2026-07-09"
author: "Hunter Hammonds"
category: "Getting Paid"
readingTime: "8 min read"
ogTitle: "Why Clients Pay Late, and the Follow-Up Cadence That Fixes It"
...
faq:
  - q: "How long should I wait before following up on an unpaid invoice?"
    a: "Do not wait. Confirm the invoice arrived the day you send it, nudge on the due date, and follow up three days after it goes past due. The longer an invoice sits, the harder it is to collect."
  - q: "Is it rude to follow up on a late payment?"
    a: "No. You did the work and the money is owed. A calm, dated reminder that restates the invoice number and amount reads as professional, not pushy. Most late payments are disorganization, not refusal, so a clear reminder usually just fixes it."
  - q: "How often should I follow up on an overdue invoice?"
    a: "On a fixed schedule, roughly every three to seven days, escalating channel as you go: email, then text, then a phone call. Consistency matters more than volume. A predictable cadence collects more than occasional angry messages."
  - q: "Can I charge a late fee to get clients to pay on time?"
    a: "Often yes, if your contract or invoice states the fee up front, but the legal limit varies by state. This is general information, not legal advice. Check an authoritative source and your written agreement before you add one."
  - q: "What do I do if a client still will not pay after follow-ups?"
    a: "Move to a direct phone call, then a formal written past-due notice that restates the terms and any late fee. If that fails, options include a payment plan, a collections service, or small claims court, all of which vary by state."
---
...
Most late payments are not refusals. They are a client who can pay but has not gotten to it yet, which is why a reminder usually works. The problem is real in scale: US small businesses with outstanding invoices are owed more than $17,000 each on average, and 47% of businesses report having a portion of their invoices more than 30 days past due, per the [2025 Intuit QuickBooks Small Business Late Payments Report](https://quickbooks.intuit.com/r/small-business-data/small-business-late-payments-report-2025/). In the trades it is worse: [Built's 2025 research](https://getbuilt.com/blog/70-percent-of-contractors-say-payment-delays-threaten-industry/) found 70% of contractors regularly face payment delays.

Here are the five reasons, ranked by how often they are the real cause.

1. Cash-flow juggling. The client has the money but is timing their own outflows. They are paying whoever pushes, in the order they get pushed. A dated reminder moves you up their queue.
2. The invoice got lost or never arrived. It went to spam, to the wrong person, or to an inbox nobody checks. The client is not ignoring you because there is nothing in front of them to ignore. A read receipt or a quick "did this land" text solves it.
3. A quiet dispute or a surprise line item. Something on the invoice does not match what they expected, so instead of calling, they just sit on it. Silence is often a disagreement in disguise. Asking directly surfaces it.
4. No consequence for waiting. If nothing happens when an invoice goes 15, 30, or 45 days past due, waiting is free. Clear terms and a steady follow-up create a reason to pay now instead of later.
5. You are last in the pile. Bigger vendors, payroll, and rent all shout louder. A one-person shop that sends one invoice and goes quiet is the easiest bill to defer. Showing up consistently is what keeps you from being the one that slides.
...
| --- | --- | --- |
| Day 0 (invoice sent) | Email | Send the invoice with a clear due date, amount, and payment link. State the terms in plain words. |
| Day 1 | Email or text | Confirm it arrived. "Just making sure this landed in the right inbox." Catches lost invoices early. |
| Due date | Email | Friendly same-day nudge. "This is due today, here is the link." No pressure, just presence. |
...
| Due +14 | Email | Formal past-due notice. Restate terms and any late fee stated in your contract. Keep it calm. |
...
1. Send the invoice with the due date, amount, and a payment link in the first line.
2. The next day, confirm it arrived.
3. On the due date, send a same-day nudge with the link again.
4. Three days past due, send the first past-due check-in and invite any question.
5. One week past due, call. Do not email. Get a date on the phone.
6. Two weeks past due, send a formal but calm past-due notice restating terms.
7. Thirty days past due, send a final notice and offer a payment plan before escalating.
...
This is general information, not legal advice. Before you add a late fee, read an authoritative source such as [Nolo's guide to charging late fees and finance charges](https://www.nolo.com/legal-encyclopedia/question-when-charge-late-fees-finance-charges-28337.html) and confirm your written agreement supports it. The cadence above collects most invoices without a fee ever coming up. Treat the fee as a backstop for the small number of clients who need a consequence, not as your opening move.
